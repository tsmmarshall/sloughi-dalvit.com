...
//----------------------------------- Document ready -----------------------------------//
       ...
       $(document).ready(function() {	
			...
			if (!$.trim($(this).val())) { //if this field is empty 
			  ...
			  $("#contact_results").html('<br><div class="alert alert-danger">Vyplňte prosím zvýrazněná pole.</div>').show();
			...
			if ($(this).attr("type") === "email" && !email_reg.test($.trim($(this).val()))) {
				$(this).css('border-color', '#e44747'); 
				$("#contact_results").html('<br><div class="alert alert-danger">Zadejte prosím platný email.</div>').show();
				proceed = false; //set do not proceed flag				
			}
			});
